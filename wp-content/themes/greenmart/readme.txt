...
A starter theme called Greenmart, or underscores.
...
- [FIX] Fix not receiving Google Font on 'flower' skin
- [FIX] Fix 'Variation Swatches For WooCommerce Pro' plugin not working correctly on home page

Version 4.1.3 - June 15, 2023
...
- [FIX] Fix Out Of Date the file "greenmart\woocommerce\cart\cart.php" 
- [FIX] Fix Out Of Date the file "greenmart\woocommerce\cart\mini-cart.php" 
- [FIX] Fix Out Of Date the file "greenmart\woocommerce\single-product\product-image.php" 
- [FIX] Fix Out Of Date the file "greenmart\woocommerce\global\quantity-input.php" 
- [FIX] Fix the mobile menu not receiving the Elementor page builder on the "Fresh" Skin

Version 4.1.2 - May 12, 2023
- [FIX] Fix bug add-on 'Greenmart List Categories Product' on the Elementor page builder

Version 4.1.1 - April 12, 2023
- [ADD NEW] Add new options "Show Quantity Product" in Theme Options/WooCommerce Theme/Checkout
- [ADD NEW] Add new feature "Quantity Product" on Review Order on page Checkout

Version 4.1 - March 20, 2023
- Compatible with PHP 8.1
- Compatible with WooCommerce 7.5.x

Version 4.0.19 - March 01, 2023
- [FIX] Fix the plugin MultiVendorX – MultiVendor Marketplace Solution For WooCommerce 4.0.x and above

Version 4.0.18 - February 16, 2023
...
Version 4.0.16 - December 22, 2022
...
Version 4.0.13 - November 03, 2022
...
Version 4.0.10 - September 14, 2022
...
- [ADD NEW] Add new "Min/Max Quantity Option"
...
- Compatible with Fix MVX version 3.7 3.2.x
...
- [ADD NEW] Add New Demos "Organic WCFM" and "Organic MVX" and "Organic WC Vendors" with the Elementor Page Builder plugin.
...
Version 3.0.2 - November 20, 2020
...
- [FIX] Fix bug zoom form search in mobile
...
- [Important] Required  with WPBakery Page Builder version 6.0.2 or greater
...
Version 2.3 - May 14, 2019
- [Important] Required "Tbay framework" version 2.1 or greater
...
= Version 2.2.3 - April 02, 2019
- [ADD NEW] Enable AJAX Add to Cart on single product page (Support product type: simple + variable)
...
- Compatible with Slider Revolution 5.4.7.4
- [ADD] Config for carousel element in visual composer:
	+ Autoloop
	+ Autoplay
	+ Autoplay speed
...
- Fixbug dont' shown/hide breadcum in page shop
- Fix Error log when adding product quantity
- Fix js in ios
- Add new customize greenmart thumbnail in mini cart or single product image thumbnail
- Fixbug Don't config Blog Columns in theme options
- Fix title page search in mobile


= 1.4.8 - February 22, 2018 =
...
= 1.4.7 - January 31, 2018 =
- Compatible with woocommerce 3.3
- Update plugin Slider Revolution 5.4.6.6
- Add new options on theme options: Disable Add to cart fixed on mobile (Single Product Pag)
...
- Fix bug don't show logo in customize
- Add new options on theme options: Disable the Password Strength Meter
- Add new options on theme options: max width logo and padding logo

= 1.4.6 - January 27, 2018 =
