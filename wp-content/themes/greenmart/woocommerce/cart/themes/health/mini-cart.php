						...
						if($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key)) {
							...
							<li id="mcitem-<?php echo esc_attr($cart_item_key); ?>">
								...
								<?php if ( ! $_product->is_visible() ) : ?>
									...
									<span class="count"><?php echo apply_filters('woocommerce_widget_cart_item_quantity',  sprintf('%s', $cart_item['quantity']) , $cart_item, $cart_item_key); ?>
									</span>
								<?php else : ?>
									<a class="mcitem-img" href="<?php echo esc_url( $product_permalink ); ?>">
										<?php echo trim($thumbnail);  ?>

										<?php if( !greenmart_tbay_get_config('show_mini_cart_qty', false) ) : ?>
											<span class="count"><?php echo apply_filters('woocommerce_widget_cart_item_quantity',  sprintf('%s', $cart_item['quantity']) , $cart_item, $cart_item_key); ?>
										</span>
										<?php endif; ?>
