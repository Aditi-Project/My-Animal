	...
	<div class="row">
		...
		<div class="col-xs-12 col-md-9">
							...
							<span class="product-remove">
								<?php
									...
									echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
										'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="icon-trash icons"></i></a>',
			...
			<div class="cart-bottom clearfix">
				<div class="pull-left update-cart">
					<input type="submit" class="btn btn-default update<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="update_cart" value="<?php esc_attr_e( 'Update Cart', 'greenmart' ); ?>" />
		...
		<div class="col-xs-12 col-md-3">
			...
			<div class="coupon">
				...
				<div class="box"><input type="text" name="coupon_code" id="coupon_code" value="" class="text" /><span class="input-group-btn"><input type="submit" class="btn btn-default<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply', 'greenmart' ); ?>" /></span></div>
